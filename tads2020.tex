...
\begin{itemize}
	\item \textbf{Semestre:} 5
	\item \textbf{Carga horária (hora/aula):} 54
	\item \textbf{Objetivo:} Identificar aspectos históricos, legais, culturais, conceituais, gramaticais e linguísticos da Língua Brasileira de Sinais (LIBRAS). Utilizar com propriedade a LIBRAS para a comunicação elementar com o surdo. Contribuir para a inclusão social e linguística do surdo.
	\item \textbf{Ementa:} 
	Aspectos históricos, legais, culturais, conceituais, gramaticais e linguísticos da Língua Brasileira de Sinais - LIBRAS;
	Vocabulário básico, construção de enunciados e comunicação na LIBRAS;
	A inclusão do surdo na sociedade por meio das tecnologias.
	\item \textbf{Bibliografia Básica}
	\begin{enumerate}
		\item \cite{cartilha2012}
		\item 
...
\begin{itemize}
	\item \textbf{Semestre:} 5
	\item \textbf{Carga horária (hora/aula):} 27
	\item \textbf{Objetivo:} Conscientizar o estudante das implicações éticas e legais relacionadas à  cidadania, ao mundo do trabalho e, principalmente, ao exercício profissional no campo  da informática. 
	\item \textbf{Ementa:}
	Teorias éticas: clássicas, modernas e contemporâneas;
	Ética e mundo do  trabalho;
	Dimensões éticas no uso e desenvolvimento das tecnologias da informação;
	Responsabilidade civil, penal e o mundo da informática. Contratos e direitos do  consumidor;
	Direitos autorais e propriedade intelectual;
	Marco civil da internet (Lei Nº  12.965/2014), Lei de Proteção de Dados (Lei Nº 13.709/ 2018). 
	\item \textbf{Bibliografia Básica}
	\begin{enumerate}
		\item%\cite{cartilha2012}
		\item 
